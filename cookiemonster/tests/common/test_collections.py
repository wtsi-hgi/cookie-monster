...
class TestFileUpdateCollection(unittest.TestCase):
    ...
    def test_can_instantiate_with_list(self):
        file_updates_list = [FileUpdate("", "", datetime.min), FileUpdate("", "", datetime.min)]
    ...
    def test_can_instantiate_with_file_update_collection(self):
        file_updates1= FileUpdateCollection([FileUpdate("", "", datetime.min), FileUpdate("", "", datetime.min)])
    ...
    def test_get_most_recent(self):
        file_updates = FileUpdateCollection([
            FileUpdate("", "", datetime.max),
            FileUpdate("", "", datetime.min)
        ])
